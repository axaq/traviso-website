...
Traviso aims to give you a lot of flexibility in terms of customisation. What you see above is the minimum and default settings. For a list of customisation items go ahead and read the related tutorial <a href="/blog/{% post_url 2015-03-15-engine-configuration %}" target="_self">here</a>.
